...
public class SQLusuarios extends conexion {
    ...
    public boolean login(usuarios usr) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                // el 3 significa en que columna va a evaluar del query de arriba (contraseña)
                if (usr.getContraseña().equals(rs.getString(3))) 
                {
                    usr.setIdusuarios(rs.getInt(1));
                    usr.setNombre(rs.getString(4));
                    usr.setIdRoles(rs.getInt(5));
                     b.crearBitacora(l,rs.getString(4));
                    return true;
                } else {
                    return false;
                }
    ...
    //compara usuario al registro para comprobar si existe el mimsmo usuario o no
